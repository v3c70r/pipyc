...
class Motor:
    def __init__(self):
        self._turn_left_pin = 7
        self._turn_right_pin = 11
        self._forward_pin =13
        self._backward_pin =15
